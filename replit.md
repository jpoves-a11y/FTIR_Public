...
The application includes a trial limit system that restricts usage for new users.
...
### Redundant Storage
Trial data is stored in multiple layers for resilience:
- localStorage
- IndexedDB
- Cache API
- sessionStorage
...
### Hidden Admin Reset
Administrators can reset the trial limit using:
